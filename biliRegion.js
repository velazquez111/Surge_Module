...
async function SwitchRegion(play) {
	const Group = $.read('BiliArea_Policy') || '💻AsianTV'; //Your blibli policy group name.
	const CN = $.read('BiliArea_CN') || 'Direct'; //Your China sub-policy name.
	const TW = $.read('BiliArea_TW') || '🇨🇳'; //Your Taiwan sub-policy name.
	const HK = $.read('BiliArea_HK') || '🇨🇳'; //Your HongKong sub-policy name.
